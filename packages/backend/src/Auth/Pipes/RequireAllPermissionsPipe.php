...
/**
 * Requires ALL listed permissions. Denies if any are missing.
 *
 *     ->group('/admin', [new RequireAllPermissionsPipe(['admin.access', 'design.access'])])
 *
 * Must run AFTER SessionAuthPipe (needs AuthContext populated).
 */
class RequireAllPermissionsPipe implements Pipe
{
    /** @var string[] */
